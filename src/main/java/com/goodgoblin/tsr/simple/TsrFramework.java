 ...
 */
package com.goodgoblin.tsr.simple;
...
/**
 * simple framework that will run a scheduler that in turn will cause
 * Docker containers to be launched that will build a project from source code.
 *
 * Source code adapted from the example that ships with Mesos.
 * Source code adapted/copied from codefutures tutorial
 */
public class TsrFramework {

  /** Show command-line usage. */
  private static void usage() {
    String name = TsrFramework.class.getName();
    System.err.println("Usage: " + name + " master-ip-and-port git-repo-url");
  }

  /**
   * Command-line entry point.
   * <br/>
   * Example usage: java Framework master:5050 https://github.com/goodgoblin/ruby-sample.git
   */
  public static void main(String[] args) throws Exception {
    ...
    final Scheduler scheduler = new TsrScheduler(
        imageName,
        totalTasks
    );
